...
ApplicationWindow{
    ...
    {
        hyPower = seriesData["HyPower"][seriesData["HyPower"].length - 1]
        liPower = seriesData["LiPower"][seriesData["LiPower"].length - 1]
        ...
        hyPowerPointerWrapper.pointerAngle = -30 + 240 * hyPower / 1000
        ...
        hyRemainPointerWrapper.pointerAngle = -30 + hyRemain * 240 / 36
        hyRemainIncicator.text = String(hyRemain) + "MPa"
        liRemainPointerWrapper.pointerAngle = -30 + (liRemain - 27) * 240 / 6.6
